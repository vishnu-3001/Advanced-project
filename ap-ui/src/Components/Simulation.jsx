...
//         console.log(errors);
//         if(errors.length>0){
//             return {errors,enterdValues:{tweak}}
//         }
//         console.log(tweak);
//         return {errors:null,enterdValues:{tweak}}
//     }
//     useEffect(()=>{
...
//                 {!generate&&<button className={classes.genericButton} onClick={handleGenerate}>Generate</button>}
//                 {generate&&(
//                     <div className={classes.tweakContainer}>
//                         <form className={classes.tweakForm} action={formAction}>
//                             <textarea className={classes.tweakInput} 
//                             placeholder="Please enter your required changes or more inputs for simulation"
//                             id="tweak"
//                             name="tweak"
//                             defaultValue={formState.enterdValues?.tweak}
//                             ></textarea>
//                             {
...
//                                 })
//                             }
//                             <button className={classes.genericButton} type='submit'>Simulate</button>
//                         </form>
//                     </div>
//                 )}
