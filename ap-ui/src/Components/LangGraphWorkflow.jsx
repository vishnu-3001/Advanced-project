...
export default function LangGraphWorkflow() {
    ...
    async function startTutorSession() {
        try {
            ...
            const resp = await fetch('https://starfish-app-9fd8s.ondigitalocean.app//api/v1/openai/generate_tutor', {
                method: 'POST',
    ...
    async function runWorkflow() {
        ...
        try {
            const response = await fetch('https://starfish-app-9fd8s.ondigitalocean.app//api/v2/langgraph/workflow', {
                method: 'POST',
                headers: {
    ...
    async function generateProblemOnly() {
        ...
        try {
            const response = await fetch('https://starfish-app-9fd8s.ondigitalocean.app//api/v2/langgraph/generate-problem', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
